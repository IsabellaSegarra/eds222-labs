...
The test statistic is a difference in proportions. 
...
# Difference of poroptions between gs and ps (your HA is better)
...
restoration_summary$prop_success[2] - restoration_summary$prop_success[1]
...
geom_vline(xintercept = 0.1416667) # Add a vertical line 
...
p_val <- sum(null_distribution) >= obs_test/1000
