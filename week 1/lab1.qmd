...
"MexBrewer::Alacena"
```
2-3 sentences about the data (where you got it from and what it represents) 
A contingency table, bar plot, histogram, or scatterplot summarizing the data
1-2 sentences interpreting the table/figure
...
ggplot(sf_community_gg, aes(Sector_General, fill = Commodity_Type)) +
   geom_bar() +
   scale_fill_paletteer_c("pals::coolwarm") +
     labs(x = "Sector type", 
          title = "San Fransisco Emission Types") +
   theme_minimal() +
   theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1))+
   scale_fill_paletteer_d(palette = "colorBlindness::Blue2OrangeRed14Steps") + 
   theme(
